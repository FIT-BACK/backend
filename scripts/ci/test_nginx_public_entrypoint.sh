...
grep -Fq 'proxy_set_header Forwarded "";' "$repo_root/deploy/nginx/default.conf"
grep -Fq 'proxy_set_header X-Forwarded-Host $host;' "$repo_root/deploy/nginx/default.conf"
...
grep -Fq 'proxy_set_header X-Forwarded-Prefix "";' "$repo_root/deploy/nginx/default.conf"

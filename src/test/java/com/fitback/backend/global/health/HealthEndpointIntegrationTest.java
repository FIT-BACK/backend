...
import com.fitback.backend.domain.analysis.service.ImageStorage;
...
class HealthEndpointIntegrationTest {
    ...
    @Test
    void productionProfileDoesNotUseLocalMultipartImageStorage() {
        assertThat(imageStorage.getClass().getSimpleName())
                .isEqualTo("UnavailableMultipartImageStorage");
    }
